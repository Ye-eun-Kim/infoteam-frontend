...
git은 파일을 크게 두 종류로 나누어 관리합니다. 하나는 변경 사항을 계속 추적하는 Tracked, 변경 사항 추적에서 제외하는 Untracked입니다. 이 명령어를 실행하면, Tracked 파일들의 변경사항을 알려줍니다. 일단 기본적으로 저장소 내 모든 파일은 Tracked입니다.
